                ...
                <div class="col-12">
                    <div class="box">
                        <div class="box-header with-border d-flex justify-content-between align-items-center">
                            ...
                            <a href="add-advisor" class="fs-5" style="color: #082D33; text-decoration: none;">Add Advisor <i class="fi fi-rr-add"></i></a> <!-- Aligning Data Sekolah and Add Sekolah in one line -->
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                ...
                                <table id="complex_header" class="table table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bold">
                                                <a href="/edit-advisor" class="btn text-white fw-bold"
